...
/*
  ...
  В абзацах переносов нет вовсе: они размечались под колонку 532 из макета, а
  после приведения масштаба к сценариям колонка 360 — на ней те же переносы
  давали рваные короткие строки.
*/
const SCENARIOS: Scenario[] = [
  {
    ...
    effects: [
      "Изолированная рабочая область для каждой команды",
    ...
    body: (
      <>
        ...
        <p>
          ...
          системы и&nbsp;опишите правила в&nbsp;навыке&nbsp;— и команда сможет
          использовать его в&nbsp;ежедневной работе.
        </p>
      </>
    ),
    effects: [
...
const STEPS: { number: string; title: string; text: ReactNode }[] = [
  ...
  },
  {
    ...
    text: (
      <>
        Откройте сотрудникам доступ, настройте роли{" "}
        <br className="hidden lg:inline" />и работайте над&nbsp;задачами вместе
        с&nbsp;агентами.
      </>
    ),
  },
