...
const NAV_ITEMS: NavItem[] = [
  ...
  { label: "Поставки", href: "/pricing" },
  {
    ...
    /*
      ...
      25.09.2026 «Обучающие видео» заменены «Академией»: ролики целиком вошли
      в неё первым блоком, и два пункта на одно и то же в меню не нужны. Сама
      /guides пока жива и доступна по прямой ссылке — из навигации убрана.
    */
    children: [
