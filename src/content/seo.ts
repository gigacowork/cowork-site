...
export const PAGE_SEO: Record<string, PageSeo> = {
  ...
  aiPlatform: {
    ...
    description:
      "GigaCowork — корпоративная платформа ИИ-агентов: рабочие пространства, интеграции, базы знаний, автоматизация по расписанию и безопасное развертывание.",
    keywords:
  ...
  guides: {
    ...
    description:
      "Короткие видеоинструкции по работе с платформой GigaCowork: агенты, задачи, пространства, интеграции.",
    keywords:
      "видеоинструкции gigacowork, как работать с gigacowork, обучение работе с ии агентами, подключение интеграций gigacowork, подключение коннекторов gigacowork, быстрые команды gigacowork, GigaCowork, ГигаКоворк, Коворк, Cowork",
    ogTitle: "Как работать с GigaCowork — видеоинструкции",
    ogDescription:
      "Короткие видео о ключевых возможностях платформы: постановка задач, навыки агентов, команды, интеграции и совместные пространства.",
    jsonLd: {
      "@context": "https://schema.org",
      "@graph": [
        {
  ...
  */
  ...
  agents: {
    ...
    description:
      "GigaCowork — ИИ-агенты для бизнеса: самостоятельное построение плана действий, работа с документами, интеграциями и навыками, контроль через журнал событий.",
    keywords:
    ...
    jsonLd: {
      ...
      "@graph": [
        ...
        },
        {
          ...
          description:
            "ИИ-агенты самостоятельно строят план действий по конечной цели, работают с документами, интеграциями и навыками, выполняют задачи параллельно с пользователем и по расписанию. Все действия фиксируются в журнале событий.",
          applicationCategory: "BusinessApplication",
          operatingSystem: "Web",
          brand: {
            "@id": "https://cowork.ru/#brand",
          ...
          featureList: [
            ...
            "Работа с документами и интеграциями с корпоративными системами",
  ...
  connectors: {
    ...
    title: "GigaCowork: интеграции с корпоративными системами",
    description:
      "GigaCowork — более 40 готовых интеграций: CRM, 1С, почта, мессенджеры и другие сервисы, а также поддержка собственных MCP-серверов.",
    keywords:
      "интеграции для ии агентов, коннекторы для ии агентов, интеграция ии с crm, ии для 1с, mcp серверы, mcp коннекторы, подключение корпоративных систем к ии, GigaCowork, ГигаКоворк, Коворк, Cowork",
    ogTitle: "Интеграции с корпоративными системами — GigaCowork",
    ogDescription:
      "Более 40 готовых интеграций с CRM, 1С, почтой и мессенджерами, а также поддержка собственных MCP-серверов.",
    jsonLd: {
      "@context": "https://schema.org",
      "@graph": [
        {
        ...
        },
        {
          ...
          name: "GigaCowork: интеграции с корпоративными системами",
          description:
            "GigaCowork — более 40 готовых интеграций: CRM, 1С, почта, мессенджеры и другие сервисы, а также поддержка собственных MCP-серверов.",
          inLanguage: "ru-RU",
          isPartOf: {
        ...
        },
        {
          "@type": "SoftwareApplication",
          "@id": "https://cowork.ru/ai-platform/connectors#software",
          name: "Интеграции GigaCowork",
          description:
            "Готовые интеграции с почтовыми сервисами, календарями, облачными хранилищами, CRM, ERP, таск-трекерами, мессенджерами и другими корпоративными системами, а также поддержка собственных MCP-серверов.",
          applicationCategory: "BusinessApplication",
          operatingSystem: "Web",
          brand: {
            "@id": "https://cowork.ru/#brand",
          ...
          featureList: [
            "40+ готовых интеграций с корпоративными системами",
            "Поддержка собственных MCP-серверов",
